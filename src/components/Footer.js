    ...
    <footer className="bg-black mx-auto my-0 sm:px-16 px-8 sm:py-24 py-12 mt-10">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-start">
          ...
          <p className="mt-6 text-base text-white-400 sm:max-w-sm leading-7 font-montserrat">
            Build spectacular floating cities together in an on-chain massive
            multiplayer game. Featuring a unique in-game economy that is both
            Free to Play & Play to Earn. Collaboratively build your kingdom, vye
      ...
      <div className="flex justify-between text-white-400 mt-24 max-sm:flex-col max-sm:items-center">
        <div className="font-montserrat flex flex-1 justify-start items-center gap-2 cursor-pointer">
          ...
          />
          <p>
            <a href="https://github.com/Cygnusfear/laputa" target="_blank">
              Open Source. All on GitHub.
            </a>
          </p>
        </div>
        <p className="font-montserrat cursor-pointer">
          <a href="https://ethglobal.com/showcase/laputa-fg9ku" target="_blank">
            {" "}
            Made at EthGlobal Online 2023.
          </a>
        </p>
      </div>
    </footer>
